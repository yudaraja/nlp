            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">nlp system</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Petualangan dimulai di sini 🚀</h4>
              <p class="mb-4">Uji pengetahuan umum Anda dan jadikan belajar lebih seru!</p>
              @if($errors->any())
